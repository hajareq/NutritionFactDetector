            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">NFD Login</span>
                </a>
              </div>
            </div>
              ...
              <form action="${contextPath}/login" method="post">
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <span>${message}</span>
                    <input type="username" name="username" class="form-control input-lg" id="email" aria-describedby="emailHelp" placeholder="Username">
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <p>Don't have an account yet ?
                      <a class="text-blue" href="${contextPath}/registration">Sign Up</a>
                    </p>
                  </div>
                </div>
              </form>
