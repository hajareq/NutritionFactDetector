      ...
      <div class="content">							<div class="breadcrumb-wrapper">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <p class="mb-5">Please enter the food you want to test.</p>

                <div class="col-10 mx-auto accordion-shadow">
                  <div class="card bg-light mx-auto">
                    <div class="card-body">
                      <form class="horizontal-form" method="post" action="${contextPath}/foodtest">
                        <div class="form-group row">
                          <div class="col-12 col-md-3 text-right">
                            <label for="text">Food To Test</label>
                          </div>
                          <div class="col-12 col-md-9 accordion-shadow">
                            <input type="text" id="text" class="form-control" name="foodtest" placeholder="Enter Food">
                          </div>
                        </div>
