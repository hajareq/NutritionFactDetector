                                ...
                                <table class="table card-table table-responsive table-responsive-large" style="width:100%">
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="d-none d-md-table-cell">research Date</th>
                                      <th>Results</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                        ...
                                        <c:forEach items="${data}" var="elements">
                                          ...
                                          <td>${elements.getProductType()}</td>
                                          <td>${elements.getKeywords()}</td>
                                          <td>${elements.getDate()}</td>
                                            <td><span class="badge
                                            <c:if test="${elements.getResult() == \"Clean product\"}" >
                                            <c:out value="badge-success"></c:out>
                                            </c:if>
                                            <c:if test="${elements.getResult() == \"Dangerous product\"}" >
                                            <c:out value="badge-danger"></c:out>
                                            </c:if>
                                          ">${elements.getResult()}</span></td>
                                          </tr>
                                        </c:forEach>
                                      <td >
