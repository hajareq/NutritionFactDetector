      ...
      <div class="content">							<div class="breadcrumb-wrapper">
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <p class="mb-5">Please enter the Drink you want to test.</p>

                <div class="col-10 mx-auto accordion-shadow">
                  <div class="card bg-light mx-auto">
                    <div class="card-body">
                      <form class="horizontal-form" method="post" action="${contextPath}/drinktest">
                        <div class="form-group row">
                          <div class="col-12 col-md-3 text-right">
                            <label for="text">Drink To Test</label>
                          </div>
                          <div class="col-12 col-md-9 accordion-shadow">
                            <input type="text" id="text" class="form-control" name="drinktest" placeholder="Enter drink">
                          </div>
                        </div>
