  ...
  <div class="page-wrapper">
    ...
    <div class="content-wrapper">
      <div class="content">							<div class="breadcrumb-wrapper">
        ...
        <div class="shadow card card-default ">
          <div class=" shadow-sm card-header card-header-border-bottom">
            <h2>Results for "your choice"</h2>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <p class="mb-5">This is the results that we could find for your research. Please note that these results might be incomplete.</p>

                <div class="col-6 mx-auto accordion-shadow">
                  <div class="card bg-light mx-auto">
                    <img class="shadow-sm card-img-top" src="assets/img/elements/cc3b.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title text-primary text-center">Ingredients</h5>
                      <div class="col-lg-14">
                          ...
                          <ul class="list-group">
                            <c:forEach items="${data}" var="element">
                              <li class="list-group-item
                                <c:if test="${element.value == \"ok\"}">
                                  <c:out value="list-group-item-success">

                                  </c:out>
                                  </c:if>
                                 <c:if test="${element.value == \"error\"}">
                                  <c:out value="list-group-item-danger">

                                  </c:out>
                                </c:if>
                              <c:if test="${element.value == \"ko\"}">
                                <c:out value="list-group-item-danger">
